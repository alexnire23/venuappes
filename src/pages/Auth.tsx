    ...
    <div className="min-h-screen flex flex-col bg-background safe-top safe-bottom">
      <div className="flex-1 flex flex-col px-5 pt-16 pb-8">
        ...
        <div className="flex items-center gap-4 mb-5">
          ...
          <span className="text-[13px] text-muted-foreground" style={{ fontFamily: 'Inter, sans-serif' }}>o</span>
          <div className="flex-1 h-px bg-border" />
        </div>
        ...
        <button
          ...
          className="w-full h-12 bg-card border border-border rounded-full flex items-center justify-center gap-2.5 text-[14px] text-foreground font-medium transition-opacity hover:opacity-70"
          style={{ fontFamily: 'Inter, sans-serif' }}
        >
